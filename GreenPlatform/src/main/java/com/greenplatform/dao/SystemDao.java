...
public interface SystemDao {
    //系统用户操作begin
    public List selectPlateuser (PlateUser plateUser);//查询平台用户
    ...
    //能量减少表操作
    public List selectTGreenNlJsnlmx (TGreenNlJsnlmx tGreenNlJsnlmx);//查询能量减少明细

    public int insertTGreenNlJsnlmx (TGreenNlJsnlmx tGreenNlJsnlmx);//插入能量减少明细

    public int delTGreenNlJsnlmx (TGreenNlJsnlmx tGreenNlJsnlmx);//删除能量减少明细

    public int updTGreenNlJsnlmx (TGreenNlJsnlmx tGreenNlJsnlmx);//修改能量减少明细
    ...
    //任务明细
    public List selectTGreenZzZjzzmx (TGreenZzZjzzmx tGreenZzZjzzmx);//查询增加种子明细

    public int insertTGreenZzZjzzmx (TGreenZzZjzzmx tGreenZzZjzzmx);//插入增加种子明细

    public int delTGreenZzZjzzmx (TGreenZzZjzzmx tGreenZzZjzzmx);//删除增加种子明细

    public int updTGreenZzZjzzmx (TGreenZzZjzzmx tGreenZzZjzzmx);//修改增加种子明细
