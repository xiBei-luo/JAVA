...
CREATE TABLE `plate_code_dmlb` (
  ...
  `N_CJUSER` int(11) DEFAULT NULL COMMENT '创建人',
  `D_CJSJ` datetime DEFAULT NULL COMMENT '创建时间',
  `N_XJUSER` int(11) DEFAULT NULL COMMENT '修改人',
...
-- ----------------------------
INSERT INTO `plate_code_dmlb` VALUES ('C_RYLB', '人员类别', '1', '1', '2019-05-06 00:00:00', '1', '2019-05-06 00:00:00');
INSERT INTO `plate_code_dmlb` VALUES ('C_RYZT', '人员状态', '1', '1', '2019-05-06 00:00:00', '1', '2019-05-06 00:00:00');
INSERT INTO `plate_code_dmlb` VALUES ('C_ZCFS', '注册方式', '1', '1', '2019-05-06 00:00:00', '1', '2019-05-06 00:00:00');
INSERT INTO `plate_code_dmlb` VALUES ('C_ZJLX', '证件类型', '1', '1', '2019-05-06 00:00:00', '1', '2019-05-06 00:00:00');
...
CREATE TABLE `plate_code_dmz` (
  ...
  `N_SORT` varchar(255) DEFAULT NULL,
...
-- ----------------------------
INSERT INTO `plate_code_dmz` VALUES ('C_RYLB', '1', '系统用户', '1', null, '1', '1', '2019-05-06 00:00:00', '1', '2019-05-06 00:00:00');
INSERT INTO `plate_code_dmz` VALUES ('C_RYZT', '1', '正常', '1', null, '1', '1', '2019-05-06 00:00:00', '1', '2019-05-06 00:00:00');
INSERT INTO `plate_code_dmz` VALUES ('C_ZCFS', '1', '手机号码', '1', null, '1', '1', '2019-05-06 00:00:00', '1', '2019-05-06 00:00:00');
INSERT INTO `plate_code_dmz` VALUES ('C_ZJLX', '1', '身份证', '1', null, '1', '1', '2019-05-06 00:00:00', '1', '2019-05-06 00:00:00');
INSERT INTO `plate_code_dmz` VALUES ('C_RYLB', '2', '前端用户', '2', null, '1', '1', '2019-05-06 00:00:00', '1', '2019-05-06 00:00:00');
INSERT INTO `plate_code_dmz` VALUES ('C_RYZT', '2', '违规', '2', null, '1', '1', '2019-05-06 00:00:00', '1', '2019-05-06 00:00:00');
INSERT INTO `plate_code_dmz` VALUES ('C_ZCFS', '2', '微信号', '2', null, '1', '1', '2019-05-06 00:00:00', '1', '2019-05-06 00:00:00');
INSERT INTO `plate_code_dmz` VALUES ('C_ZCFS', '3', 'QQ号', '3', null, '1', '1', '2019-05-06 00:00:00', '1', '2019-05-06 00:00:00');
...
CREATE TABLE `plate_log` (
  `N_CZRZBH` int(255) NOT NULL COMMENT '操作日志记录编号',
  ...
  `N_BGR` int(255) DEFAULT NULL COMMENT '变更人',
  `C_BGRXM` varchar(255) DEFAULT NULL COMMENT '变更人姓名',
  `D_BGSJ` datetime DEFAULT NULL COMMENT '变更时间',
  `N_CJUSER` int(255) DEFAULT NULL COMMENT '创建人',
  `D_CJSJ` datetime DEFAULT NULL COMMENT '创建时间',
  `N_XGUSER` int(255) DEFAULT NULL COMMENT '修改人',
  `D_XGSJ` datetime DEFAULT NULL COMMENT '修改时间',
  PRIMARY KEY (`N_CZRZBH`)
...
CREATE TABLE `plate_user` (
  `N_USERID` int(11) NOT NULL COMMENT '用户ID',
...
-- ----------------------------
INSERT INTO `plate_user` VALUES ('1', 'admin', '系统管理员', 'aaaaaa', '1', '1', null, null, null, null, null, null, null, null, null, '1', '1', '2019-05-06 00:00:00', '1', '2019-05-06 00:00:00');
...
CREATE TABLE `plate_user_ywqx` (
  ...
  `N_SQUSERID` int(11) DEFAULT NULL COMMENT '授权人',
  `N_CJUSER` int(11) DEFAULT NULL COMMENT '创建人',
  `D_CJSJ` datetime DEFAULT NULL COMMENT '创建时间',
  `N_XJUSER` int(11) DEFAULT NULL COMMENT '修改人',
  `D_XGSJ` datetime DEFAULT NULL COMMENT '修改时间'
...
-- ----------------------------
INSERT INTO `plate_user_ywqx` VALUES ('1', 'GROW_PLATE_STGL', '1', '1', '2019-05-07 00:00:00', '1', '2019-05-07 00:00:00');
INSERT INTO `plate_user_ywqx` VALUES ('1', 'GROW_PLATE_STGL', null, null, null, null, null);
INSERT INTO `plate_user_ywqx` VALUES ('1', 'GROW_PLATE_STGL', null, null, null, null, null);
INSERT INTO `plate_user_ywqx` VALUES ('1', 'GROW_PLATE_STGL', null, null, null, null, null);
INSERT INTO `plate_user_ywqx` VALUES ('1', 'GROW_PLATE_STGL', null, null, null, null, null);
INSERT INTO `plate_user_ywqx` VALUES ('1', 'GROW_PLATE_ZHSJGL', '1', '1', '2019-05-07 00:00:00', '1', '2019-05-07 00:00:00');
...
-- ----------------------------
INSERT INTO `plate_yw_lx` VALUES ('GROW_PLATE', '平台业务', '平台业务', null, '1', '1', '2019-05-07 00:00:00', '1', '2019-05-07 00:00:00');
INSERT INTO `plate_yw_lx` VALUES ('GROW_SYSTEM', '前端业务', '前端业务', null, '1', '1', '2019-05-07 00:00:00', '1', '2019-05-07 00:00:00');
...
-- ----------------------------
INSERT INTO `plate_yw_lx_menu` VALUES ('GROW_PLATE', 'GROW_PLATE_YHGL', '用户管理', '1', null, '1', '2019-05-07 00:00:00', '1', '2019-05-07 00:00:00');
INSERT INTO `plate_yw_lx_menu` VALUES ('GROW_PLATE', 'GROW_PLATE_RWGL', '任务管理', '1', null, '1', '2019-05-07 00:00:00', '1', '2019-05-07 00:00:00');
INSERT INTO `plate_yw_lx_menu` VALUES ('GROW_PLATE', 'GROW_PLATE_NLGL', '能量管理', '1', null, '1', '2019-05-07 00:00:00', '1', '2019-05-07 00:00:00');
INSERT INTO `plate_yw_lx_menu` VALUES ('GROW_PLATE', 'GROW_PLATE_SPGL', '商品管理', '1', null, '1', '2019-05-07 00:00:00', '1', '2019-05-07 00:00:00');
INSERT INTO `plate_yw_lx_menu` VALUES ('GROW_PLATE', 'GROW_PLATE_STGL', '收徒管理', '1', null, '1', '2019-05-07 00:00:00', '1', '2019-05-07 00:00:00');
INSERT INTO `plate_yw_lx_menu` VALUES ('GROW_PLATE', 'GROW_PLATE_ZHSJGL', '账户升级管理', '1', null, '1', '2019-05-07 00:00:00', '1', '2019-05-07 00:00:00');
