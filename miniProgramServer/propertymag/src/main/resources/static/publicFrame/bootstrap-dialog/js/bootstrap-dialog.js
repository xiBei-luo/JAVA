...
(function (root, factory) {
    ...
    if (typeof module !== 'undefined' && module.exports) {
        module.exports = factory(require('jquery'), require('static/publicFrame/bootstrap-3.3.7-dist/js/bootstrap'));
    }
    // AMD module is defined
    else if (typeof define === "function" && define.amd) {
        define("bootstrap-dialog", ["jquery", "static/publicFrame/bootstrap-3.3.7-dist/js/bootstrap"], function ($) {
            return factory($);
        });
    } else {
